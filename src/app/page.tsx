        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            <div className="p-6 bg-white shadow-lg rounded-lg animate-fadeInUp">
              <Image
                src="bluefeather/bluefeather/feature1.svg"
                alt="Feature 1"
                width={100}
                height={100}
            ...
            <div className="p-6 bg-white shadow-lg rounded-lg animate-fadeInUpDelayed">
              <Image
                src="bluefeather/bluefeather/feature2.svg"
                alt="Feature 2"
                width={100}
                height={100}
                className="mx-auto mb-4"
            ...
            <div className="p-6 bg-white shadow-lg rounded-lg animate-fadeInUpMoreDelayed">
              <Image
                src="bluefeather/bluefeather/feature3.svg"
                alt="Feature 3"
                width={100}
                height={100}
                className="mx-auto mb-4"
            ...
            {[
              ...
              >
                <div className="relative w-32 h-32 mx-auto mb-4">
                  <Image
                    src={`bluefeather/bluefeather/team/${member.name}.jpg`}
